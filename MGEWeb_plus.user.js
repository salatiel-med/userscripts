...
waitForElm("mge-player-video video").then((elem)=>{
    document.querySelector(".video-player-wrapper").appendChild(document.querySelector("mge-player-video video"))
    document.querySelector("mge-player-video video").setAttribute("controls", "")
